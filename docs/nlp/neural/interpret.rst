...
En el contexto de aprendizaje profundo, los *salency maps* se introdujeron por primera vez en el artículo titulado "Deep Inside Convolutional Networks: Visualizing Image Classification Models and Saliency Maps". Este método se deriva del concepto de *salency* en las imágenes el cual se refiere a características únicas (píxeles, resolución, etc.) de la imagen en el contexto del procesamiento visual. Estas características únicas representan las ubicaciones visualmente atractivas en una imagen. El mapa es, finalmente, una representación topográfica de tales pixeles. 
...
.. toctree::
   ...
   Salency maps para NLP utilizando AllenNLP <allennlp_interpret.ipynb>
